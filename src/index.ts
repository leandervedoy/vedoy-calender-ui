export type CalendarUiEvent = { id: string; title: string; startsAt: string; endsAt: string; source?: string; attendees?: string[]; reminderMinutes?: number; meetingUrl?: string };
